...
import VTCPay from "../../../../assets/star/vtcpay-logo.png";
    ...
    <div className='h-full'>
      ...
      <div className="content h-full ">
        ...
        <div className="list-deposit flex items-center justify-center gap-x-10 lg:flex-col lg:gap-y-10 mb-10">
          ...
          <div onClick={()=>{handleMethodChange("vtcpay")}} className={`deposit h-52 w-80 cursor-pointer hover:border-primary hover:shadow-circle hover:border-2 object-cover ${method === "vnpay" ?  "" : "active"}`}>
            <img src={VTCPay}  className="w-full h-full" alt="vtcpay"  />
          </div>
        </div>
